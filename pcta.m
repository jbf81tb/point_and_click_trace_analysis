...
uicontrol('Parent',fh_text,...
    ...
    'Fontsize',14,...
    'Fontweight','bold',...
    'String',{'(escape) Exit the program.',...
              '(q,w,e): Set first frame and fast frame, then save the trace.',...
              '(a,s): Go back and forward by 1 frame.',...
              '(z,x,c): Zoom in, zoom out, or return to normal.',...
              '(n,h,p): Show index number, declare hotspot, or declare pair.',...
              '(l,u): Lock or unlock frame scrolling.',...
              '(delete): Delete a trace (will ask for confirmation)',...
